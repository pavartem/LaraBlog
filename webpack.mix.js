...
mix.styles([
    'resources/assets/front/assets/css/bootstrap.min.css',
    'resources/assets/front/assets/css/font-awesome.min.css',
    'resources/assets/front/assets/css/animate.min.css',
    'resources/assets/front/assets/css/owl.carousel.css',
    'resources/assets/front/assets/css/owl.theme.css',
    'resources/assets/front/assets/css/owl.transitions.css',
    'resources/assets/front/assets/css/style.css',
    'resources/assets/front/assets/css/responsive.css'
], 'public/css/front.css');

mix.scripts([

    'resources/assets/front/assets/js/jquery-1.11.3.min.js',
    'resources/assets/front/assets/js/bootstrap.min.js',
    'resources/assets/front/assets/js/owl.carousel.min.js',
    'resources/assets/front/assets/js/jquery.stickit.min.js',
    'resources/assets/front/assets/js/menu.js',
    'resources/assets/front/assets/js/scripts.js'

], 'public/js/front.js');

mix.copy('resources/assets/front/assets/fonts', 'public/fonts');

mix.copy('resources/assets/front/assets/images', 'public/images');